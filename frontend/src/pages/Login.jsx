...
>
  <div className="w-screen h-screen bg-gradient-to-l from-[#51b8c4] to-[#2b26ac] text-white flex flex-col items-center justify-start relative">
    {/* Header */}
    <div
    ...
    <div className="max-w-[600px] w-[90%] h-auto bg-[#00000025] border border-[#96969635] backdrop-blur-2xl rounded-lg shadow-lg flex items-center justify-center mt-6">
      ...
      >
        {/* Google Login */}
        <div
          className="w-full h-[50px] bg-[#42656cae] rounded-lg flex items-center justify-center gap-3 cursor-pointer hover:bg-[#557f86] transition-all"
        ...
        {/* Input Fields */}
        <div className="w-full flex flex-col items-center justify-center gap-4 mt-4 relative">
          <input
            type="email"
          ...
          {!show && (
            <IoMdEyeOff
              className="w-[20px] h-[20px] cursor-pointer absolute bottom-[40%] right-[6%]"
          ...
          <p className="text-sm text-gray-300 mt-2">
            You have no account?{' '}
            <span
              className="text-[#141418cf] font-semibold cursor-pointer hover:underline"
    ...
    <footer className="absolute bottom-4 text-sm text-gray-200">
      © {new Date().getFullYear()} Developed and Designed By - Ayush Patel
    </footer>
  </div>
</motion.h1>
  );
