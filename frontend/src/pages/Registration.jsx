...
import google from '../assets/vcart logo.png';
      ...
      <div className="max-w-[600px] w-[90%] h-auto bg-[#00000025] border border-[#96969635] backdrop-blur-2xl rounded-lg shadow-lg flex items-center justify-center mt-6">
        ...
        >
          ...
          <div className="w-full flex flex-col items-center justify-center gap-4 mt-4">
            ...
            /> {!show && <IoMdEyeOff className='w-[20px] h[20px] cursor-pointer absolute right-[6%]' onClick={() => setShow(prev => !prev)} />}
            {show && <FaEye className='w-[20px] h[20px] cursor-pointer absolute right-[6%]' onClick={() => setShow(prev => !prev)} />}
            {/* Submit Button */}
            <button
              type="submit"
